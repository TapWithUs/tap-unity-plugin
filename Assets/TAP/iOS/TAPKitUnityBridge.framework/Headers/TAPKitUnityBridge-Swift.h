...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TAPKitUnityBridge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC17TAPKitUnityBridge14TAPCombination")
...
SWIFT_CLASS("_TtC17TAPKitUnityBridge12TAPInputMode")
...
SWIFT_CLASS("_TtC17TAPKitUnityBridge13TAPKitCentral")
@interface TAPKitCentral : NSObject
@property (nonatomic, weak) id <TAPKitDelegate> _Nullable delegate;
...
@interface TAPKitCentral (SWIFT_EXTENSION(TAPKitUnityBridge)) <CBCentralManagerDelegate>
...
@interface TAPKitCentral (SWIFT_EXTENSION(TAPKitUnityBridge))
- (void)start;
- (void)addWithDelegate:(id <TAPKitDelegate> _Nonnull)delegate;
- (void)removeWithDelegate:(id <TAPKitDelegate> _Nonnull)delegate;
- (void)setTAPInputMode:(NSString * _Nonnull)newMode forIdentifier:(NSString * _Nullable)identifier;
...
SWIFT_PROTOCOL("_TtP17TAPKitUnityBridge14TAPKitDelegate_")
@protocol TAPKitDelegate
@optional
...
SWIFT_CLASS("_TtC17TAPKitUnityBridge9TAPKitLog")
